...
public class ViewProfile extends javax.swing.JFrame {
     ...
     */
    public ViewProfile(DBConectivity DB, User session) {
        initComponents();
        this.DB = DB;
        this.session = session;
        
        Object[] profile = this.session.getDataUserById(session.id);
        
        this.nama.setText(profile[0].toString());
        this.email.setText(profile[1].toString());
        this.nohp.setText(profile[2].toString());
        this.password.setText(profile[3].toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/views/user/46178.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nohp, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            int confirm = JOptionPane.showConfirmDialog(null, "Yakin ingin Menghapus Akun Anda?");
            ...
            if(confirm == 0){
                ...
                JOptionPane.showMessageDialog(null,"Berhasil Menghapus Akun! Otomatis Logout!");
            }
        } catch(Exception err){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nohp = this.nohp.getText();
        String password = this.password.getText();

        if(nama == "" || email == "" || nohp == "" || password == ""){
            JOptionPane.showMessageDialog(null,"Lengkapi Semua Kolom!");
        } else {
           if(!new UserController(session).update(session.id,session.email,email,nama,nohp,password)){
                Object[] profile = this.session.getDataUserById(session.id);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewProfile(ViewProfile.DB, ViewProfile.session).setVisible(true);
            }
        });
    }
